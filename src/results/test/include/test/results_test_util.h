...
///@{
/**
 * Create a result tree containing array data generated by a given range.
 */
...
/**
 * Create a ResultTree representing an array of a half-open range of ints.
 *
 * @param start the fist int in the array.
 * @param stop the first int not in the array.
 */
SQ_ND ResultTree int_array_data_tree(PrimitiveInt start, PrimitiveInt stop);

/**
 * Create a ResultTree containing a single primitive value.
 */
