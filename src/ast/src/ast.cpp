...
void parse_query(Ast& parent, Query& q);
void parse_field_tree(Ast& parent, FieldTree& ft);
void parse_field_tree_list(Ast& parent, FieldTreeList& ftl);
void parse_field_call(Ast& parent, FieldCall& fc);
void parse_parameters(Ast& parent, ParameterList& pl);
void parse_parameter(Ast& parent, Parameter& p);
void parse_list_filter(Ast& parent, ListFilter& lf);
[[nodiscard]] ElementAccessSpec parse_list_element_access(ListElementAccess& lea);
[[nodiscard]] SliceSpec parse_simple_list_slice(SimpleListSlice& sls);
[[nodiscard]] SliceSpec parse_list_slice(ListSlice& ls);
[[nodiscard]] Primitive  parse_primitive_value(PrimitiveValue& pl);
template <typename T> T parse_integer(TerminalNode& i);
[[nodiscard]] PrimitiveString parse_dq_str(TerminalNode& dq_s);
[[nodiscard]] PrimitiveBool parse_boolean(Boolean& b);
...
ElementAccessSpec parse_list_element_access(ListElementAccess& lea)
{
...
SliceSpec parse_simple_list_slice(SimpleListSlice& sls)
{
    SliceSpec ret;
...
SliceSpec parse_list_slice(ListSlice& ls)
{
    SliceSpec ret;
...
Primitive parse_primitive_value(PrimitiveValue& pl)
{
...
template <typename T>
T parse_integer(TerminalNode& i)
{
...
PrimitiveString parse_dq_str(TerminalNode& dq_s)
{
...
PrimitiveBool parse_boolean(Boolean& b)
{
...
Ast generate_ast(const std::string& sq_command)
{
    ...
    ASSERT(ftl_ptr);
    auto root = Ast{ast_root_node_name};
